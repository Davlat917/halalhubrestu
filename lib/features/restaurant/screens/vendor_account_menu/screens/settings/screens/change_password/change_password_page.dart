...
import 'package:halalhub_restaurant/features/restaurant/screens/vendor_account_menu/screens/settings/mixins/change_password_page_mixin.dart';
import 'package:halalhub_restaurant/features/restaurant/screens/vendor_account_menu/screens/settings/screens/change_password/sections/change_password_form_section.dart';

@RoutePage()
class ChangePasswordPage extends ResponsiveSection {
  const ChangePasswordPage({super.key, this.initialEmail});

  final String? initialEmail;

  @override
  Widget buildMobile(BuildContext context) {
    return ChangePasswordScaffold(
...
class ChangePasswordScaffold extends StatefulWidget {
  ...
  @override
  State<ChangePasswordScaffold> createState() => _ChangePasswordScaffoldState();
}

class _ChangePasswordScaffoldState extends State<ChangePasswordScaffold>
    with ValidationMixin, ChangePasswordPageMixin {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<AccountSettingsCubit, AccountSettingsState>(
        listener: listenChangePassword,
        builder: (context, state) {
          final isLoading =
              state.passwordRequestStatus == AccountSettingsStatus.loading;
          return Scaffold(
            ...
            body: SafeArea(
              child: ChangePasswordFormSection(
                formKey: formKey,
                emailController: emailController,
                isLoading: isLoading,
                validateEmail: validateEmail,
                maxContentWidth: widget.maxContentWidth,
                onSubmit: () => submitChangePassword(context),
              ),
            ),
          );
        },
